...
The system accepts a natural language request, interprets the requested cryptocurrency pair and exchanges, retrieves public live market data, calculates a theoretical arbitrage result after estimated fees, and prints a beginner-friendly report.
...
The `NaturalLanguageInterpreter` performs simple NLP using keyword extraction, pattern matching, intent recognition, exchange detection, and pair parsing.
...
`FEE_RATE=0.002` means the calculator estimates a 0.2 percent fee rate for the buy side and sell side combined calculation.
